...
import com.jsoft.shoppingapp.databinding.ViewpagerImageItemBinding

class ViewPager2Images : RecyclerView.Adapter<ViewPager2Images.ViewPager2ImageViewHolder>() {
    inner class ViewPager2ImageViewHolder(val binding: ViewpagerImageItemBinding) :
