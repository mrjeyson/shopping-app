...
import com.jsoft.shoppingapp.databinding.FragmentUserAccountBinding
import com.jsoft.shoppingapp.dialog.setupBottomSheetDialog
import com.jsoft.shoppingapp.utils.Resource
import com.jsoft.shoppingapp.viewmodel.UserAccountViewModel
...
class UserAccountFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSave.setOnClickListener {
            binding.apply {
                val firsName = edFirstName.text.toString().trim()
                val lastName = edLastName.text.toString().trim()
                val email = edEmail.text.toString().trim()
                val user = User(firsName, lastName, email)
